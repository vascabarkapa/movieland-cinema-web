    ...
    return (
        <div
            ...
            <Box
                ...
                sx={{backgroundImage: 'url(/assets/images/demo-content/signin_wallpaper.png)', backgroundPosition: 'center'}}
            >
                {/*<svg*/}
                ...
                <div className="z-10 relative w-full max-w-2xl">
                    ...
                    <div className="mt-24 text-lg text-right tracking-tight leading-6 text-black">
                        Following the modern times and adapting the film<br/>industry to today's digital devices, Movieland
